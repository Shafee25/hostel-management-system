...
<div class="col-sm-8">
<textarea  rows="5" name="address"  id="address" class="form-control" style="resize: none;" required="required"></textarea>
</div>
</div>
...
<label class="col-sm-2 control-label">Address : </label>
<div class="col-sm-8">
<textarea  rows="5" name="paddress"  id="paddress" class="form-control" required="required" style="resize: none;"></textarea>
</div>
</div>
