			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12"><br><br>
						<h2 class="page-title" style="color:Black">Rooms Details</h2>
						<div class="panel panel-warning">
							<div class="panel-heading" style="background-color: gray;">All Room Details</div>
...
<tr>
<td colspan="4" class="text-center text-dark" style="font-weight:bold;"><h4>Room Info</h4></td>
<td><a href="javascript:void(0);"  onClick="popUpWindow('full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details"><h4 class="text-center">Print Data</h4></a></td>
</tr>
<tr>
