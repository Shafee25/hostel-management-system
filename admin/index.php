...
<head>
    ...
    <style>
        ...
        .login-bg {
            ...
            background-image: url(img/admin.jpg); /* Using Admin Image */
        ...
        .login-bg::before {
            ...
            background: rgba(15, 23, 42, 0.6); /* Dark Blue/Black Overlay */
            backdrop-filter: blur(4px);        /* Glass Blur Effect */
        }

        /* ==================== HEADER (NAVBAR) ==================== */
        /* Overriding styles for headerindex.php */
        .brand {
            position: fixed;
        ...
        .menu-btn { color: #fff !important; font-size: 20px; cursor: pointer; margin-left: auto; }
        .ts-profile-nav { margin-left: 20px; }
        .ts-profile-nav li a { color: #fff !important; }

        /* ==================== SIDEBAR ==================== */
        /* Overriding styles for sidebarIndex.php */
        .ts-sidebar {
            position: fixed;
            top: 60px; 
        ...
        .in {
            ...
            background-color: #f0f4ff; outline: none; transition: 0.3s;
        }
        ...
        <div class="content-wrapper">
            ...
            <form action="" method="post" style="width:100%; max-width:400px;">
                <div class="main-card">
                    ...
                    <input type="text" placeholder="Username" name="username" class="in" required>
