	  	...
	  	?>	
				<div class="row">
					<div class="col-md-12 text-center" style="color:orange;">
						<h2 class="page-title" style="color: black;" ><?php echo $row->middleName;?> | Profile</h2>

						<div class="row">
							<div class="col-md-2"></div>
							<div class="col-md-8">
								<div class="panel panel-warning">
									<div class="panel-heading text-center" style="background-color: gray;size:45px;">
										User Profile : &nbsp; <?php echo $row->updationDate;?> 
									</div>
																		
									<div class="panel-body">
										<form method="post" action="" name="registration" class="form-horizontal" onSubmit="return valid();">																				
											<div class="form-group">
											<label class="col-sm-2 control-label" style="color:black;"> Registration No : </label>
											<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label" style="color:black;">First Name : </label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label" style="color:black;">Middle Name : </label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label" style="color:black;">Last Name : </label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label" style="color:black;">Gender : </label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label" style="color:black;">Contact No : </label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label" style="color:black;">Email id: </label>
<div class="col-sm-10">
