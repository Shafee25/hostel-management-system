<nav class="ts-sidebar">
    <ul class="ts-sidebar-menu">
        ...
        <?php if(isset($_SESSION['id'])) { ?>
            ...
            <li><a href="room-details.php"><i class="fa fa-file-text-o"></i>Room Details</a></li>
            <li><a href="access-log.php"><i class="fa fa-list-alt"></i>Access log</a></li>
        <?php } else { ?>
            ...
            <li><a href="admin"><i class="fa fa-user-secret"></i> Admin Login</a></li>
        <?php } ?>
    </ul>
</nav>